namespace Task1
{
  public class Point
  {
    ...
    public static explicit operator Point(double value) => new Point(value, value);
    ...
    public void Display() => Console.WriteLine($"Точка {Name}: ({X:F2}, {Y:F2})");
    ...
    public override string ToString() => $"{Name}({X:F2}, {Y:F2})";
  }
}
