...
void testPerson()
{
  cout << "=== Демонстрація роботи класу Person ===" << endl
       << endl;
  ...
  cout << "   Створено з ім'ям: " << p2.getName() << ", вік: " << p2.getAge()
       << endl;
  cout << "   (age = -1 означає, що вік не встановлено)" << endl
       << endl;
  ...
  cout << "   Телефон: " << p3.getPhoneNumber() << endl
       << endl;
  ...
  cout << "   Копія: " << p3.getName() << ", " << p3.getAge() << " років"
       << endl;
  cout << "   (копія не змінилася - це глибока копія)" << endl
       << endl;
  ...
  cout << "   Тимчасовий об'єкт знищено" << endl
       << endl;
